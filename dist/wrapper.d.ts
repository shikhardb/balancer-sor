...
import { SubGraphPools, Swap, PoolDictionary, Path, EffectivePrice, Pools } from './types';
export declare class SOR {
    ...
    constructor(Provider: BaseProvider, GasPrice: BigNumber, MaxPools: number, ChainId: number, PoolsUrl: string);
    ...
    processPairPools(TokenIn: string, TokenOut: string, poolsList: any): [PoolDictionary, Path[]];
    processPathsAndPrices(PathArray: Path[], PoolsDict: PoolDictionary, SwapType: string): [Path[], EffectivePrice[], BigNumber];
    private createKey;
